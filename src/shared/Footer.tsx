...
export const Footer = () => {
    ...
    return (
        <footer className="w-full bg-[#000513] text-gray-400 mt-10">
            <div className="max-w-screen-2xl mx-auto px-4 py-4 flex flex-col items-center space-y-4 md:flex-row md:justify-between md:items-center">
                {/* Texto de Copyright */}
