export const Navbar = () => {
  return (
      <nav className="hidden md:flex md:mx-[50px] md:py-[5px] md:px-[20px] md:gap-3 md:rounded-[20px] md:shadow-md md:scale-90 lg:scale-100 lg:mx-[150px] lg:py-[10px] lg:px-[30px] lg:gap-5 lg:rounded-[30px] lg:shadow-lg bg-gradient-to-r from-[#1e1e1e] to-[#3a3a3a] justify-center items-center">
